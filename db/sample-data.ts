const sampleData = {
  products: [
    ...
    },
    {
      ...
      description: 'Sophisticated evening gown with a sleek design',
      images: [
        '/images/sample-products/d1-1.png',
        '/images/sample-products/d1-2.png',
      ],
      price: 199.99,
    ...
    },
    {
      ...
      images: [
        '/images/sample-products/d2-1.png',
        '/images/sample-products/d2-2.png',
      ],
      price: 49.95,
      brand: 'Summer Bliss',
      rating: 4.4,
